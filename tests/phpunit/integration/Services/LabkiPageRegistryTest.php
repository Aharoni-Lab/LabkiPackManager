...
final class LabkiPageRegistryTest extends MediaWikiIntegrationTestCase {
    ...
    private function newPack(): PackId {
        ...
        $repoId = $repos->ensureRepoEntry('https://example.com/repo-pages');
        
        $refs = new LabkiRefRegistry();
        $refId = $refs->ensureRefEntry($repoId, 'main');
        
        $packs = new LabkiPackRegistry();
        return $packs->addPack($refId, 'PackWithPages', []);
    }

    private function reg(): LabkiPageRegistry {
