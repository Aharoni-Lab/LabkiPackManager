...
-- Source: /home/daharoni/dev/LabkiPackManager/sql/tables.json
...
CREATE TABLE /*_*/labki_content_repo (
  ...
  last_fetched INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE /*_*/labki_content_ref (
  ...
  manifest_last_parsed INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE /*_*/labki_pack (
  ...
  installed_at INT UNSIGNED DEFAULT NULL,
